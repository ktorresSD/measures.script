...
#Export data
 write.csv( pcl_5_scores, "C:/Users/Psychiatry Lab/Documents/Biobank/20_21_PCL_5/pcl5_entire_life_reduced_data_export_20171219.csv",quote=T,row.names=F,na="#N/A")
