...
pcl_5_current <- function(x)
{
   ...
   pcl_incomplete <- sum(pcl5_m_1_memories,
    ...
    scores <- data.frame(pcl_b,pcl_c,pcl_d,pcl_e,pcl_total,pcl_33,pcl_5_dsm,data_complete_pcl_curr)
...
#Export data
 write.csv( pcl_5_scorescurr, "C:/Users/Psychiatry Lab/Documents/Biobank/20_21_PCL_5/pcl5_current_reduced_data_export_20171219.csv",quote=T,row.names=F,na="#N/A")
