...
#Read all data
 dat_0 <- read.csv('joined_data_export_20171218.csv',header=T,na.strings=c(NA,999))
...
#Export data
 write.csv( batl_scores, "~/Biobank/3_BAT-L/batl_reduced_data_export_20171218.csv",quote=T,row.names=F,na="#N/A")
