#########################################################################################
# Last Date modified: 8/9/2018
# Author: Katy Torres
# Description: Subset of question 20, PCL LIFETIME
##########################################################################################
dat <- read.csv('C:/Users/Nievergelt Lab/Documents/GWAS_Freeze2_CURRENT/58_Risbrough/pheno_2/pheno_from_vickie_PCLonly_for_scoring.csv',header=T,na.strings=c("#N/A",NA))
#Load plyr library
 library(plyr)
...
#Calculate summary scores in data 
 ...
 #Export
 #----------------------------------------------------------------------------------------
 filename <- paste("C:/Users/Nievergelt Lab/Documents/GWAS_Freeze2_CURRENT/58_Risbrough/pheno_2/PCL_scored.csv", sep="")
